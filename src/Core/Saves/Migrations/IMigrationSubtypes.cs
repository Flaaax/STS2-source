...
public static class IMigrationSubtypes
{
	...
	[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]
	private static readonly Type _t12 = typeof(SettingsSaveV3ToV4);

	[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]
	private static readonly Type _t13 = typeof(SettingsSaveV4ToV5);

	[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)]
	private static readonly Type _t14 = typeof(SettingsSaveV5ToV6);

	private static readonly Type[] _subtypes = new Type[15]
	{
		_t0, _t1, _t2, _t3, _t4, _t5, _t6, _t7, _t8, _t9,
		_t10, _t11, _t12, _t13, _t14
	};
